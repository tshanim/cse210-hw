...
class Program
{
    static void Main(string[] args)
    {
        ...
        Comment video1Comment1 = new Comment("Luisa", "This is truly inspiring! I love how you explore the ancient ruins and share their history.");
        ...
        // Video 2
        Video video2 = new Video("Hidden Gems of Peru: Uncovering Mysteries in the Andes", "John Mercedes Palomino", 975);
        ...
        // Video 3
        Video video3 = new Video("peruvian Cuisine: A Gastronomic Adventure", "Mirriam velasquez Soto", 650);
        ...
        Comment video3Comment2 = new Comment("Renata", "I love how you present our traditional dishes. I defintely need to try them all.");
        Comment video3Comment3 = new Comment("Fernando", "Peruvian food is famous worldwide, and your videos perfectly captures its essence.");
