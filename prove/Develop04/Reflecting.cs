...
public class ReflectingActivity : Activity
{
    private List<string> _prompts = new List<string> {
        "Think of a scenario where you tood up for someone else.",
        "Think of a situation when you faced a truly difficult task.",
        "Think of a moment when you extended help to someone in need.",
        "Think of an experience where you deminstarted genuine selflessness.",
        "Think of a time when you took a risk to support a worthy cause.",
        "Think of an occasion when you overcame a mojor obstacle through perseverance.",
        ...
        "Think of an experience where you demonstrated exceptional emphathy towards someone in distress.",
    ...
    private List<string> _questions = new List<string> {
        ...
        "How can you integrate the insights gained from the experience into future endeavors?",
        "What significance does this experience hold for you?",
        "Have you previously encountered a similar situation?",
        "What were the initial steps you took to initaite this process?",
    ...
    public ReflectingActivity()
    {
        ...
        SetDescription("This activity will help you reflect on times in your life when you shown strength and resilience. thsi help you recognize the power you have and how you can use it in other apsects of your life.");
    }
    ...
    public void PromptReflecting()
    {
        ...
        Console.WriteLine();
        Console.WriteLine("Consider the following propmpt:");
        Console.WriteLine();
